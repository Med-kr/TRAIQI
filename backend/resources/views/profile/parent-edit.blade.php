...
@section('content')
    <section class="space-y-6 lg:space-y-8">
        <div>
            <p class="text-sm font-semibold uppercase tracking-[0.22em] text-[#0A4FAF]">Compte parent</p>
            <h1 class="mt-2 text-3xl font-semibold text-slate-950 sm:text-4xl">Mon profil</h1>
            <p class="mt-3 max-w-3xl text-sm leading-7 text-slate-600">Gérez vos informations de contact et la sécurité de votre compte famille.</p>
        </div>
            ...
            <section class="admin-card p-6 sm:p-7">
                ...
                <div class="mt-5 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">{{ $user->parentProfile?->phone ?? 'Téléphone non renseigné' }}</p>
                    </div>
                </div>
            </section>
