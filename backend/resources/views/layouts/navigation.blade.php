<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->hasRole('administration'))
                        <x-nav-link :href="route('administration.reports.index')" :active="request()->routeIs('administration.reports.*')">
                            Reports
                        </x-nav-link>
                        <x-nav-link :href="route('administration.users.index')" :active="request()->routeIs('administration.users.*')">
                            Users
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->hasRole('administration'))
                <x-responsive-nav-link :href="route('administration.reports.index')" :active="request()->routeIs('administration.reports.*')">
                    Reports
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('administration.users.index')" :active="request()->routeIs('administration.users.*')">
                    Users
                </x-responsive-nav-link>
            @endif
        </div>
