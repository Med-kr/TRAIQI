@php
    $schoolLinks = [
        ...
        ['label' => 'Utilisateurs', 'route' => 'admin.user-management.index', 'icon' => 'users'],
        ['label' => 'Classes', 'route' => 'admin.classrooms.index', 'icon' => 'panel'],
        ['label' => 'Matières', 'route' => 'admin.subjects.index', 'icon' => 'book'],
        ['label' => 'Imports Excel', 'route' => 'admin.imports.index', 'icon' => 'upload'],
        ['label' => 'Rapports', 'route' => 'admin.reports.index', 'icon' => 'chart'],
        ['label' => 'Logs activité', 'route' => 'admin.logs.index', 'icon' => 'clipboard'],
        ['label' => 'Paramètres', 'route' => 'profile.edit', 'icon' => 'settings'],
    ];
@endphp
...
>
    <div class="flex items-center justify-between gap-3 pb-6">
        <a href="{{ route('home') }}" class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-lg font-semibold">Administration école</p>
            </div>
        </a>
    ...
    <div class="rounded-[1.5rem] border border-white/12 bg-white/10 p-4 backdrop-blur">
        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-white/68">Pilotage établissement</p>
        <p class="mt-3 text-sm leading-7 text-white/86">Gérez les utilisateurs, les classes, les imports et les rapports avec une interface calme, dense et fiable.</p>
    </div>
    ...
    <div class="mt-auto space-y-4 pt-6">
        <div class="rounded-[1.5rem] border border-white/12 bg-gradient-to-br from-white/12 to-white/6 p-4">
            <p class="text-sm font-semibold">Rythme quotidien</p>
            <p class="mt-2 text-sm leading-7 text-white/74">Imports, suivi des comptes, classes actives, rapports et traces d’activité dans un même espace.</p>
        </div>
